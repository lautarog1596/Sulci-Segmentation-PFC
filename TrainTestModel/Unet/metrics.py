...
from TrainTestModel.Unet.losses import compute_per_channel_dice
from TrainTestModel.Unet.utils import expand_as_one_hot
...
class MeanIoU:
    ...
    def __call__(self, input, target):
        ...
        # input = F.softmax(input, dim=1) ######## no va xq ya está en la funcion que lo llama, trainer
